...
import { Nombre,setStyle } from '../host/Info';
...
import { IconSize } from '../host/Info';
                ...
                <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    ...
                    {/*    <li onClick={()=>setScreen("Tienda 2")}  className="nav-item">
                        ...
                        <li onClick={()=>setScreen("Cliente")}>
                            ...
                            <i class="fas fa-users fa-lg"></i><span className="ms-1 d-none d-md-none d-xl-inline">Cliente</span> </button>
                           
                        </li>
                        <li onClick={()=>setScreen("Informe")}>
                        <button    className="nav-link px-0 align-middle">
                        <i class="fas fa-chart-bar fa-lg"></i><span className="ms-1 d-none d-md-none d-xl-inline">Informe</span></button>
                        </li>
                        <li onClick={()=>setScreen("Empleado")}> 
                            <button    data-bs-toggle="collapse" className="nav-link px-0 align-middle " >
                            <i class="fas fa-users fa-lg"></i> <span className="ms-1 d-none d-md-none d-xl-inline">Empleado</span></button>
                           
                        </li>
                        <li onClick={()=>setScreen("Bodega")}>
                            <button   data-bs-toggle="collapse" className="nav-link px-0 align-middle">
                            <i class="fas fa-th-large fa-lg"></i><span className="ms-1 d-none d-md-none d-xl-inline">Bodega</span> </button>
                                
                        </li>

                        <li onClick={()=>setScreen("Caja")}>
                            <button   data-bs-toggle="collapse" className="nav-link px-0 align-middle">
                            <i class="fas fa-cash-register fa-lg"></i><span className="ms-1 d-none d-md-none d-xl-inline">Caja</span> </button>
                               
                        </li>

                        <li onClick={()=>setScreen("Proveedor")}>
                            <button    className="nav-link px-0 align-middle">
                            <i class="fas fa-user fa-lg"></i> <span className="ms-1 d-none d-md-none d-xl-inline">Proveedores</span> </button>
                        </li>
                        <li onClick={cerrarSesion}>
                            <button    className="nav-link px-0 align-middle">
                            <i class="fas fa-sign-out fa-lg" ></i> <span className="ms-1 d-none d-md-none d-xl-inline">Salir</span> </button>
                        </li>
                    </ul>
                    <hr/>
